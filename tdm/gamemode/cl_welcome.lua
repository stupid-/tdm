...
function welcomePlayer( ply )
	...
	--ChooseTeamFrame.startTime = SysTime()
	function ChooseTeamFrame:Paint( w, h, ply )
		--Derma_DrawBackgroundBlur(ChooseTeamFrame, ChooseTeamFrame.startTime)
	...
	--SpectatorButton:SetPos(ScrW()/3 - (ScrW()/10)/2, 0 + (ScrH()/4)/1.5 + ScrH()/20 + (ScrH()/20)/6 )
